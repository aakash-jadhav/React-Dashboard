    ...
    <div className="grid sm:grid-cols-12 gap-3 ">
      <div className="sm:col-span-6 md:col-span-3 bg-[#202028] rounded-lg p-4">
        ...
        <div className="flex items-center justify-between mt-5">
          ...
          <p className="text-green-500  font-bold flex items-center justify-end ">
      ...
      <div className="sm:col-span-6 md:col-span-3 bg-[#202028] rounded-lg p-4">
        ...
        <div className="flex items-center justify-between mt-5">
          ...
          <p className="text-red-500  font-bold flex items-center justify-end ">
      ...
      <div className="sm:col-span-6 md:col-span-3 bg-[#202028] rounded-lg p-4">
        ...
        <div className="flex items-center justify-between mt-5">
          <h1 className="text-xl font-bold">05</h1>
